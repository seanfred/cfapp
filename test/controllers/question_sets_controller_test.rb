...
class QuestionSetsControllerTest < ActionController::TestCase
  ...
  test "should create question_set" do
    assert_difference('QuestionSet.count') do
      post :create, question_set: { created_at: @question_set.created_at, name: @question_set.name, updated_at: @question_set.updated_at }
    end
  ...
  test "should update question_set" do
    patch :update, id: @question_set, question_set: { created_at: @question_set.created_at, name: @question_set.name, updated_at: @question_set.updated_at }
    assert_redirected_to question_set_path(assigns(:question_set))
  end
